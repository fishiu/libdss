...
//各类文献资源数量
$sqlKind = "SELECT firstkind,count(firstKind) 
FROM (SELECT ebookID, ebooks.bookID, firstkind FROM ebooks,books WHERE ebooks.bookID = books.bookID) AS tb 
GROUP BY firstKind;";
...
// 写入文件
file_put_contents('../json/pl_2.3.5.txt', $json_string);
